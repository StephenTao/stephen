...
_CTX_THREAD_LOCAL_NAME = "HIGHLANDER_APP_CTX_THREAD_LOCAL"
...
class HighlanderContext(BaseContext):
    ...
    def __repr__(self):
        return "HighlanderContext %s" % self.to_dict()
