...
from highlander.openstack.common import fileutils
from highlander.openstack.common.gettextutils import _, _LE, _LI
...
util_opts = [
    ...
    cfg.StrOpt('lock_path',
               default=os.environ.get("HIGLANDER_LOCK_PATH"),
...
def main(argv):
    ...
    os.environ["HIGLANDER_LOCK_PATH"] = lock_dir
    try:
